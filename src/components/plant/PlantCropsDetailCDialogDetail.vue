    ...
    <el-dialog v-model="dialogVisible" :title="title" width="1200px" :before-close="handleClose" append-to-body>
        ...
        <div class="form">
            <div class="item">
                ...
                <div class="content">
                    <el-input v-model="form.name" placeholder="请输入种植植物" />
                </div>
            </div>
            <div class="item">
                <p class="title">农事类型：</p>
                <div class="content">
                    <el-input v-model="input" placeholder="请输入农事类型" />
                </div>
            </div>
            <div class="item">
            ...
            <div class="item">
                ...
                <div class="content">
                    <el-input v-model="input" placeholder="请输入作业方式" />
                </div>
            </div>
            <div class="item">
                <p class="title">操作时间：</p>
                <div class="content">
                    <el-input v-model="input" placeholder="请选择操作时间" />
                </div>
            </div>
            <div class="item">
                <p class="title">操作人：</p>
                <div class="content">
                    <el-input v-model="input" placeholder="请输入操作人" />
                </div>
            </div>
            <div class="item">
            ...
            <div class="item itemBig">
                <p class="title">备注：</p>
                <div class="content">
                    <el-input v-model="input" placeholder="请输入备注" />
                </div>
            </div>
            <div class="item itemBig">
